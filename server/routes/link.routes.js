...
import { createLink, getShelfLinks, getCompostLinks, clickLink, reactToLink, searchShelfLinks, searchMyShelfLinks, deleteLink, getLinkSuggestions, addLinkSuggestion, deleteLinkSuggestion } from '../controllers/link.controller.js';
import { getContextFeed } from '../controllers/context.controller.js';

const router = Router();

router.post('/',                authMiddleware, createLink);
router.get('/search/mine',      authMiddleware, searchMyShelfLinks);
