...
import { Home, BookOpen, Trash2, User, Bell, LogOut, Network, Compass, MessageCircle, Star, PanelRightClose, PanelRightOpen } from 'lucide-react';
...
const navItems = [
  ...
  { to: '/starred',         icon: Star,           label: 'Starred Shelves'},
